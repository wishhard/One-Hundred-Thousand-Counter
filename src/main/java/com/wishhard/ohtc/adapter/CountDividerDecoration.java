...
public class CountDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public CountDividerDecoration(Context mContext) {
        this.mContext = mContext;

        mDivider = ContextCompat.getDrawable(mContext, R.drawable.diviter);
